# nvim-treesitter-queries-muttrc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-muttrc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-muttrc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **muttrc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-muttrc",
...
- [ ] Changes are scoped to `muttrc` — do not include files for other languages
